        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Slider {
                    id: sld
                    Layout.fillWidth: true
                    // Tope de ancho: sin él, la pista se estira con la columna de
                    // Ajustes hasta dejar de leerse como un control y parecer una
                    // regla, con el agarre perdido en medio, y apuntar a un valor
                    // concreto exige una precisión absurda. A 400 dp quedan unos
                    // 4 px por unidad en una escala de 0 a 100. Sigue siendo
                    // 'fillWidth' para encogerse en ventana estrecha.
                ...
                // La lectura va pegada a la pista y no al otro extremo de la fila:
                // el número se lee donde está el control que lo mueve, y así el que
                // cede al crecer un dígito es el hueco sobrante del final y no la
                // etiqueta, que haría temblar la línea al arrastrar.
                //
                // Y sin espaciador flexible detrás: dos elementos con fillWidth se
                // reparten el hueco a partes iguales, así que en ventana estrecha
                // el espaciador le robaría al slider la mitad del ancho. Cuando la
                // pista topa con su máximo, el layout ya deja el sobrante al final.
                ThemedText {

;;; quickshell-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme quickshell "Theme using Template variables with quality of life improvements.")
...
(let* ((bg "{{background}}")
      ...
      (primary-fixed-dim "{{primaryContainer}}")
      (secondary-fixed "{{secondary}}")
      (secondary-fixed-dim "{{secondaryContainer}}")
      (tertiary-fixed "{{tertiary}}")
      (tertiary-fixed-dim "{{tertiaryContainer}}")
      (on-primary-fixed "{{onPrimary}}")
      (on-primary-fixed-variant "{{onPrimaryContainer}}")
      (on-secondary-fixed "{{onSecondary}}")
      (on-secondary-fixed-variant "{{onSecondaryContainer}}")
      (on-tertiary-fixed "{{onTertiary}}")
      (on-tertiary-fixed-variant "{{onTertiaryContainer}}")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "{{onSurface}}")
      (inverse-primary "{{primary}}")
      (inverse-surface "{{surface}}")
      ;; ANSI terminal colors
      (term0 "{{terminalNormalBlack}}")
      (term1 "{{terminalNormalRed}}")
      (term2 "{{terminalNormalGreen}}")
      (term3 "{{terminalNormalYellow}}")
      (term4 "{{terminalNormalBlue}}")
      (term5 "{{terminalNormalMagenta}}")
      (term6 "{{terminalNormalCyan}}")
      (term7 "{{terminalNormalWhite}}")
      (term8 "{{terminalBrightBlack}}")
      (term9 "{{terminalBrightRed}}")
      (term10 "{{terminalBrightGreen}}")
      (term11 "{{terminalBrightYellow}}")
      (term12 "{{terminalBrightBlue}}")
      (term13 "{{terminalBrightMagenta}}")
      (term14 "{{terminalBrightCyan}}")
      (term15 "{{terminalBrightWhite}}"))
...
(provide-theme 'quickshell)
;;; quickshell-theme.el ends here

...
y pasan por la misma tarjeta de aprobación que las demás.

## Probarlo antes de enchufarlo

Sin el shell de por medio, con tuberías:
...
Y luego una `tools/call` de cada herramienta, incluida **una que falle** a
propósito: la mitad de los fallos de un servidor MCP están en el camino del
error, que nadie prueba.

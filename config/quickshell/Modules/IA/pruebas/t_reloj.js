...
const src = fs.readFileSync(IA + "ToolPolicy.js", "utf8").replace(/^\.pragma library$/m, "")
...
const TODAS = (fs.readFileSync(IA + "ToolDefs.js", "utf8")
...
const LT = new Function(
    fs.readFileSync(IA + "LocalTools.js", "utf8").replace(/^\.pragma library$/m, "")

...
const DIR = __dirname
const src = fs.readFileSync("/home/salesprendes/.config/quickshell/Modules/IA/LocalTools.js",
...
function trae(ruta, sinExtractores) {
    const b = mod.files("fetch_url", { url: "http://127.0.0.1:" + PUERTO + ruta },

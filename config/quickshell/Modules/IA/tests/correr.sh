...
# LLM, proceso colgado).
cd "$(dirname "$0")" || exit 1
BATERIAS="t_transporte t_redteam t_reloj t_websearch t_subagente t_fetch t_ssrf t_recetas t_depurador t_cerco t_podar t_guion t_puerta t_despacho t_endpoint t_habilidades t_rafaga t_disparadores"
